...
if __name__ == '__main__':
    ...
    for filename in files:
        ...
        subprocess.call("axel ftp://stdatu.stsci.edu/stage/anonymous/anonymous{0}/{1}".format(index, filename), shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
